...
- "agentTurn": Runs agent with message (isolated sessions only)
  { "kind": "agentTurn", "message": "<prompt>", "model": "<optional>", "thinking": "<optional>", "timeoutSeconds": <optional, 0 means no timeout>, "directSend": <optional-bool> }
  When directSend is true, the agent keeps the message tool enabled and is expected to send responses directly (e.g. with inline buttons). Cron delivery is skipped when the agent sends to the delivery target.
